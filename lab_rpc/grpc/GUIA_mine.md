...
1. É necessário instalar a ferramenta para criar ambientes virtuais:
   
        sudo apt install python3-venv
   
3. Para criar o diretório raiz no projeto gRPC:

        python -m venv venv_miner
   
3. Para Instalar gRPC, Pybreaker, e os pacotes relacionados:
...
O Cliente: 
1) consulta o ID pendente
2) consulta o valor do desafio; 
3) consulta o status de um id;
4) consulta o vencedor;
5) consulta os detalhes de solução; 
6) inicia a mineração;
